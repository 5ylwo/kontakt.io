...
public class AnomalyAnalyticsController {
  ...
  public List<String> getThermometersForDetectorAboveThreshold(
      @PathVariable AnomalyDetectorType anomalyDetectorType, @RequestParam(defaultValue = "0") Long threshold) {
  ...
  public List<AnomalyEntity> getAnomaliesForDetectorTypeAndRoomId(
      @PathVariable AnomalyDetectorType anomalyDetectorType, @PathVariable String roomId) {
  ...
  public List<AnomalyEntity> getAnomaliesForDetectorTypeAndThermometerId(
      @PathVariable AnomalyDetectorType anomalyDetectorType, @PathVariable String thermometerId) {
